...
const About = (props) =>{
    ...
    // console.log(props.data.Celebration[0]);
    ...
    return(
        <div className="About">
            ...
            <div className="Mission">
                <h1>Our Mission</h1>
                <p>Elevate one student, transform entire families. With unwavering integrity and boundless passion, we're shaping a healthier society. What's even more thrilling? Our students are joining the movement. Together, we spark a chain reaction, forging a new path :)</p>
            </div>
